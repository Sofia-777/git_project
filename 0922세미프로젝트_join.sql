...
INSERT INTO SEMI_USERTABLE VALUES('qqqqqq', 'qqqqqq', 'qqqq', 'q', 1988, 12, 24, 'qq','qqq','qq','여성', sysdate);
...
CREATE TABLE SEMI_JOINTABLE (
    ...
    j_recruit   VARCHAR2(12)     DEFAULT '모집중',                     -- 모집글 모집중/모집완료 
    ...
    j_date      DATE                    ,                            -- 모집글 작성일자9
    j_Dday      VARCHAR2(10)    NOT NULL,                            -- 모집글 마감일자(보고 달력/text)
    j_Mday      VARCHAR2(10)    NOT NULL,                            -- 모집글 만나는 일자(보고 달력/text)
    j_count     NUMBER(5)       DEFAULT 0,                           -- 모집글 조회수
    j_cost      VARCHAR2(2)     DEFAULT 'N',                         -- 모집글 비용 유무(체크박스)
    j_maxmem    NUMBER(2)       DEFAULT 2,                           -- 모집글 최대인원(text)
    j_nowmem    NUMBER(2)       DEFAULT 1,                           -- 모집글 현재인원
    j_content   VARCHAR2(3000)  NOT NULL,                            -- 모집글 내용
    j_pwd       VARCHAR(12)     NOT NULL                             -- 모집글 비밀번호
);

INSERT INTO SEMI_JOINTABLE VALUES(1, 'vvvvvv', 'a', 'a', 'a', 'a', 'a', 'a', sysdate, 'a','a' , 0, 'a',2, 1, 'a','qqqq');
