...
-- SEMI_APPLYTABLE
CREATE TABLE SEMI_APPLYTABLE(
    ap_bidx         NUMBER(4)       REFERENCES SEMI_JOINTABLE(j_idx),       -- 모집글 페이지에서 받아오는 글번호
    ap_id           VARCHAR2(15)    REFERENCES SEMI_USERTABLE(u_id),        -- 모집글 페이지에서 받아오는 아이디
